 ...
 * 5 - ALTERNATE SETUP - select alternate RX (PPM, etc.), alternate ESC-range, etc. here
...
////////////////////////////////传感器板选择
    /***************************    Combined IMU Boards    ********************************/
      ...
      //#define SIRIUS_MEGAv5_OSD //  Paris_Sirius鈩�ITG3050,BMA280,MS5611,HMC5883,uBlox  http://www.Multiwiicopter.com <- confirmed by Alex
...
/*************************************************************************************************/
  /********************************  PID Controller *********************************////PID控制器类型
   ...
   /* optionally disable stick combinations to arm/disarm the motors.
    ...
    #define ALLOW_ARM_DISARM_VIA_TX_YAW    //加锁，解锁
     ...
     * room for servo travel, then you must enable and set all three following options */
     //#define SERVO_MIN  {1020, 1020, 1020}
     //#define  SERVO_MAX {2000, 2000, 2000}
     //#define  SERVO_MID {1500, 1500, 1500} // (*)
     //#define FORCE_SERVO_RATES      {30,30,100} // 0 = normal, 1= reverse
  ...
  /***********************          Cam Stabilisation             ***********************/
    ...
    //pkj
    //#define CAMTRIG          
    #define CAM_TIME_HIGH 1000   // the duration of HIGH state servo expressed in ms  //duration持续时间
...
/*************************************************************************************************/
  ...
  /**************************************************************************************/
    ...
    /****************************    PPM Sum Reciver    ***********************************/
      /* The following lines apply only for specific receiver with only one PPM sum signal, on digital PIN 6
         Select the right line depending on your radio brand. Feel free to modify the order in your PPM order is different */
      //#define SERIAL_SUM_PPM         PITCH,YAW,THROTTLE,ROLL,AUX1,AUX2,AUX3,AUX4,8,9,10,11 //For Graupner/Spektrum
      //#define SERIAL_SUM_PPM         ROLL,PITCH,THROTTLE,YAW,AUX1,AUX2,AUX3,AUX4,8,9,10,11 //For Robe/Hitec/Futaba
      #define SERIAL_SUM_PPM         ROLL,PITCH,YAW,THROTTLE,AUX1,AUX2,AUX3,AUX4,8,9,10,11 //For Multiplex//RC系统设置
...
////////////////////////////////////promini开启Aux 2
    /*********************************    Aux 2 Pin     ***********************************/
      /* possibility to use PIN10 or PIN12 as the AUX2 RC input (only one, not both)
         it deactivates in this case the POWER PIN (pin 12) or the BUZZER PIN (pin 10) */
      //#define RCAUXPIN10
      //#define RCAUXPIN12
  ...
  //#define OVERRIDE_LEDPIN_PINMODE             pinMode (13, OUTPUT); // use A1 instead of d13
  //#define OVERRIDE_LEDPIN_TOGGLE              PINB |= 1<<1; // PINB |= 1<<5;     //switch LEDPIN state (digital PIN 13)
  //#define OVERRIDE_LEDPIN_OFF                 PORTB &= ~(1<<1); // PORTB &= ~(1<<5);
  //#define OVERRIDE_LEDPIN_ON                  PORTB |= 1<<1;    // was PORTB |= (1<<5);
...
/*************************************************************************************************/
  ...
  /******                Serial com speed    *********************************/
    ...
    #define SERIAL0_COM_SPEED 115200//串口传输
    ...
    #define NEUTRALIZE_DELAY 100000//neutralize使无效化
 ...
 */
  ...
  /********                          Failsafe settings                 ********************/
    ...
    #define FAILSAFE_OFF_DELAY 400                    // Time for Landing before motors stop in 0.1sec. 1 step = 0.1sec - 20sec in example
  ...
  /**************************************************************************************/
  /***********************      LCD configuration menu     LCD配置菜单    **************************/
  /**************************************************************************************/
  ...
  /********************************************************************/
  /****           powermeter (battery capacity monitoring)    电池容量监控     ****/
  /********************************************************************/
